...
<div class="lwa lwa-divs-only">
	...
	<form class="lwa-form" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
		<div class="lwa-username">
			<?php $msg =  esc_html__( 'Username', 'login-with-ajax' ); ?>
		...
		<div class="lwa-password">
			<?php $msg =  esc_html__( 'Password', 'login-with-ajax' ); ?>
		...
		<div class="lwa-submit-button">
			...
			<?php if( !empty($lwa_data['redirect']) && ! $lwa_data['redirect'] ): ?>
		...
		<div class="lwa-links">
			...
			<br />
			<a href="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" class="lwa-links-register-inline register"><?php esc_html_e('Register','login-with-ajax'); ?></a>
			<a href="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" class="register"><?php esc_html_e('Register','login-with-ajax'); ?></a>
			<?php endif; ?>
		</div>
	</form>
