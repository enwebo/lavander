...
gulp.task( 'clean:pot', function () {
	return del( [ 'languages/lavander.pot' ] );
} );
...
gulp.task( 'wp-pot', [ 'clean:pot' ], function () {
	...
	.pipe( wpPot( {
		'domain': 'lavander',
		'destFile': 'lavander.pot',
		'package': 'lavander',
		'bugReport': 'http://enwebo.com',
		'lastTranslator': 'enwebo <contact@enwebo.com>',
		'team': 'Team <contact@enwebo.com>'
	} ) )
...
gulp.task( 'watch', function () {
	...
	browserSync( {
		...
		'proxy': 'http://lav.dev',    // Use http://enwebo.com:3000 to use BrowserSync
		'watchOptions': {
