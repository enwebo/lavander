 ...
 */
function lavander_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', 'lavander_content_image_sizes_attr', 10 , 2 );
 ...
 */
function lavander_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'lavander_post_thumbnail_sizes_attr', 10 , 3 );
